...
public class Main extends Application {
	@Override
	/**
	 * Los 3 ejercicios están hechos.
	 * En la linea 88 solo se ha de cambiar el layout que se le manda al constructor
	 * ej1 panel
	 * ej2 panelBorde
	 * ej3 panelTelefono
	 */
	public void start(Stage primaryStage) {
		try {
			...
			Rectangle re_centro=new Rectangle(300,300,Color.DARKBLUE);
			Rectangle re_izq=new Rectangle(50,300,Color.DARKGREEN);
			Rectangle re_der=new Rectangle(50,300,Color.DARKGREEN);
			Rectangle re_arriba=new Rectangle(400,50,Color.RED);
			Rectangle re_abajo=new Rectangle(400,50,Color.RED);
			...
			Scene scene = new Scene(panelBorde,400,400);
